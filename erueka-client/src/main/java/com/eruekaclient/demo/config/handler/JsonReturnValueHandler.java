...
public class JsonReturnValueHandler implements HandlerMethodReturnValueHandler, BeanPostProcessor {
    ...
    List<ResponseBodyAdvice<Object>> adviceList = new ArrayList<ResponseBodyAdvice<Object>>();
    ...
    public void handleReturnValue(Object returnValue, MethodParameter returnType,
        ...
        for (int i = 0; i < adviceList.size(); i++) {
            ResponseBodyAdvice<Object> advice = adviceList.get(i);
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof ResponseBodyAdvice) {
            adviceList.add((ResponseBodyAdvice<Object>) bean);
